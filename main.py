...
with open('data/word_to_ix.pkl', 'rb') as wordf:
	word_to_ix = pickle.load(wordf)
params['vocab_size'] = len(word_to_ix)
with open('data/tag_to_ix.pkl', 'rb') as tagf:
...
#sample = '据我所知，随着经济发展而富裕起来的娱乐环境的繁华，很多青少年的吸烟率逐渐增长。这些变化会引起的结果将能够影响一个国家未来。'
sample = '据我所知，随着经济发展而富裕起来的娱乐环境的繁华，很多青少年的吸烟率逐渐增长。'
x = np.atleast_2d([word_to_ix[w] for w in sample] + [0]*(params['seq_len']-len(sample)))
