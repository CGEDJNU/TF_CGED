...
if __name__ == '__main__':
    ...
    iter_train_bigram, init_dict_train_bigram = pipeline_train(X_train_bigram, Y_train, sess, params, True)
    iter_test_bigram, init_dict_test_bigram = pipeline_test(X_test_bigram, sess, params, True)
